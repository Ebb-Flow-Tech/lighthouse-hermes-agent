...
TOOLSETS = {
    ...
    "hermes-lark": {
        "description": "Lark bot toolset - Lark/Feishu messaging platform (full access)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-gateway": {
        ...
        "tools": [],
        "includes": ["hermes-telegram", "hermes-discord", "hermes-whatsapp", "hermes-slack", "hermes-signal", "hermes-homeassistant", "hermes-email", "hermes-lark"]
    }
}
